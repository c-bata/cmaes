...
class CMAwM:
    ...
    def __init__(
        ...
        dim = self._cma.dim
        popsize = self._cma.population_size
        ...
        # discrete_space
        self.margin = margin if margin is not None else 1 / (dim * popsize)
        ...
        m_z = mean[self._discrete_idx].reshape(([self._n_zdim, 1]))
